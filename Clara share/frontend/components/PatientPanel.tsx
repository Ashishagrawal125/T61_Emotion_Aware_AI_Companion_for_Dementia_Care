        ...
        <div className="xl:col-span-7">
          <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <PremiumField label="Full Name" value={form.name} onChange={(v: any) => setForm({ ...form, name: v })} placeholder="e.g. Prema Devi" />
              <PremiumField label="Age" value={String(form.age)} onChange={(v: any) => setForm({ ...form, age: Number(v) })} placeholder="e.g. 72" type="number" />
              <PremiumField label="Gender" value={form.gender} onChange={(v: any) => setForm({ ...form, gender: v })} placeholder="Female / Male" />
              <PremiumField label="Dementia Stage" value={form.condition_stage} onChange={(v: any) => setForm({ ...form, condition_stage: v })} placeholder="Mild / Moderate" />
              <PremiumField label="Preferred Language" value={form.preferred_language} onChange={(v: any) => setForm({ ...form, preferred_language: v })} placeholder="Hindi / English" />
              <PremiumField label="Emergency Phone" value={form.emergency_contact} onChange={(v: any) => setForm({ ...form, emergency_contact: v })} placeholder="+91..." />
              <PremiumField label="Doctor Phone" value={form.doctor_phone} onChange={(v: any) => setForm({ ...form, doctor_phone: v })} placeholder="+91..." />
              <PremiumField label="Loved Ones" value={form.family_members} onChange={(v: any) => setForm({ ...form, family_members: v })} placeholder="Aashi (Daughter), Ramesh (Husband)" />
            </div>
